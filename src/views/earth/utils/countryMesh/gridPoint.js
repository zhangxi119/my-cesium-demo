...
// polygon:一个表示平面多边形轮廓的数组菽粟元素结构[x,y](x,y表示经纬度)
function gridPoint(polygon) {
  ...
  //经纬度极小值和极大值构成一个矩形范围，可以包褰多边形polygon，在矩形范围内生成等间距顶点
  // 设置均匀填充点的间距
  var 间隔 = 3; //polygon轮廓内填充顶点的经纬度问隔距离，选择一个合适的值，太小，计算量大，太大,
